...
# Optional arguments
parser.add_argument("--correct-phase", help="has RFMix simultaneously attempt to correct phasing errors. Significantly slows analysis and currently does not return Forward-Backward estimates", action="store_true")
...
# Run RFMix
argDict = {"window_size":"-w", "generations":"-G", "output_name": "-o", "trees": "-t", "disable_parallel":"-r", "num_threads":"-h", "bootstrap_sample_size":"-b", "bootstrap_type":"-s", "em_iterations":"-e", "use_reference_panels_in_EM":"-u", "discard_rare_variants":"-x", "mtry_factor":"-f", "forward_backward": "-fb"}
