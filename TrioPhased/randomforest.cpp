...
//      }
      ...
      for(int divisionIndex = 0; divisionIndex < numDivisions; divisionIndex++){
        ...
        for(int treeIndex = 0; treeIndex < numTrees; treeIndex++){
          ...
          Tree(0, snpHomog, windex, firstSNPIndex, windowNumSNPs, mtry, numAncPops, bootstrapSample, numAdm, numAnc, ancHapClasses, ancWindows, admWindows, admHere, treeCounts, 0);
        }
